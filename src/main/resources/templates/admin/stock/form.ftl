                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="frm" method="post" action="${ctx!}/admin/stock/edit">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="shippQuantity" name="shippQuantity" class="form-control" type="text" value="${stock.shippQuantity}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">出货地址：</label>
                                <div class="col-sm-8">
                                    <input id="shippAddress" name="shippAddress" class="form-control" type="text" value="${stock.shippAddress}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                	<input id="shippTime" name="shippTime" readonly="readonly" class="laydate-icon form-control layer-date" value="${stock.shippTime}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">退回数量：</label>
                                <div class="col-sm-8">
                                    <input id="returnQuantity" name="returnQuantity" class="form-control" type="text" value="${stock.returnQuantity}">
                                </div>
                            </div>
                            <div class="form-group">
